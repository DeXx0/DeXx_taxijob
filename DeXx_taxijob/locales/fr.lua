Locales['fr'] = {
  ...
  -- garage
  ['spawner_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour ouvrir ~y~le garage~s~.',
  ...
  ['press_to_open'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder au ~y~coffre',
  ['billing'] = 'facuration',
  ...
  ['mission_complete'] = '~r~Mission terminée',
  ['quantity'] = 'Quantité',
  ['quantity_invalid'] = '~r~Quantité invalide',
